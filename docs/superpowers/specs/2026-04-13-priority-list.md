...
9. [done] `2026-04-13-class-inheritance.md` — `feat: inherit @pre/@post contracts from base classes via extends`

## V 2.0

1. `future-liskov-aware-contracts.md` — `feat: heuristic LSP violation detection for subtype @pre constraints` *(depends on #9)*
